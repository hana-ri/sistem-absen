                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Daftar Katru Pada Perangkat di Departemen {{ $device->device_dept }}</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                <div class="row">
                                ...
                                <table id="add-row" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ ($userCard->userInfo) ? ($userCard->userInfo->status) ? 'Aktif' : 'Pasif' :  '' }}</td>
                        ...
                        <div class="card-footer">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-warning btn-round ml-auto" href="/dashboard/device/{{ $device->uid }}/edit">Perbarui</a>
                            </div>
                        </div>
                    </div>
                </div>
