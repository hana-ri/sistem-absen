                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input name="device_name" id="idDeviceName" type="text" class="form-control" placeholder="isi nama perangkat">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-group-default">
                                                            <label>Departemen</label>
                                                            <input name="device_dept" id="idDeviceDept" type="text" class="form-control" placeholder="isi nama departemen">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
