                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $userInfo->uid ? 'Aktif' : 'Pasif' }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <table id="add-row" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $userInfo->userCard ? $userInfo->userCard->device->device_dept : 'Belum ditautkan' }}
                                        </td>
                                        <td>{{ $userInfo->userCard ? $userInfo->userCard->uid : 'Belum ditautkan' }}
                                        </td>
                                        <td>{{ $userInfo->userCard ? ($userInfo->userCard->card_status ? 'Aktif' : 'Pasif') : 'Belum ditautkan' }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
